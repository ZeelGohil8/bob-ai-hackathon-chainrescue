...
Slide 1 · Title
Project: ChainRescue Tagline: Real-time AI-Powered Supply Chain Disruption & Cold-Chain Rescue Team: Alpha Squad Track: L2 — Supply Chain Disruption Assistant Team Lead: Zeel Gohil Members: Janki Zadafiya · Roshni Prajapati · Drashti Vekariya
...
Track: L2 — Supply Chain & Logistics Repo: bob-ai-hackathon-chainrescue Powered by: IBM watsonx.ai · IBM Granite · IBM Bob

Paste each section above into a slide. Keep one idea per slide. Visual tip: replace bullet points with icons and diagrams wherever possible.
